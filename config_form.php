...
<div class="field">
    ...
    <div class="inputs five columns omega">
        <p class="explanation"><?php echo __("The language to use for your site. 
                Some parts of the site might not have been translated into your language yet.
                To learn more about contributing to translations, <a href='http://omeka.org/codex/Translate_Omeka'>read this</a>."); ?> </p>
